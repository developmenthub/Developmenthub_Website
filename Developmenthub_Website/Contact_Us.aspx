<%@ Page Title="" Language="C#" MasterPageFile="~/HubMaster.Master" AutoEventWireup="true" CodeBehind="Contact_Us.aspx.cs" Inherits="Developmenthub_Website.WebForm1" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form id="contactform" action="Resources/PHP/contact.php" method="post" class="validateform" name="send-contact">
                            <div id="sendmessage">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 field">
                                    <input type="email" name="email" placeholder="* Enter your email address" data-rule="email" data-msg="Please enter a valid email" />
                                    <div class="validation">
                                    </div>
                                </div>
                                <div class="col-lg-4 field">
                                ...
                                <div class="col-lg-12 margintop10 field">
                                    ...
                                    <p>
                                        ...
                                        <span id="fill_req" class="pull-right margintop20">* Please fill all required form field, thanks!</span>
                                    </p>
                                </div>
                            </div>
                        </form>
